...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "profile.emptyChest": "Cofre Vac�o",
    "profile.emptyChestDesc": "No tienes cupones. �Organiza eventos (+25 XP), �nete a partidos (+15 XP) o usa la app diariamente para ganar cofres sorpresa!",
    "profile.epicItem": "Objeto �pico ??",
    ...
    "profile.itemClaimedDesc": "El beneficio de **{discount}** ha sido activado con �xito para tu pr�xima reserva de cancha o partido.",
    "profile.joinCommunity": "�nete a la comunidad",
    "profile.joinDesc": "Accede a todo TeamMatch gratis",
    "profile.legendaryItem": "Objeto Legendario ??",
    "profile.locked": "Bloqueado",
    "profile.loginExisting": "Ya tengo cuenta - Iniciar Sesi�n",
    "profile.magicChest": "Cofre de Objetos M�gicos",
    "profile.noXp": "A�n no has ganado experiencia. �Explora el mapa y �nete a un partido!",
    ...
    "canchas.location": "Ubicaci�n",
    "canchas.locationSelected": "Ubicaci�n seleccionada",
  ...
  en: {
    ...
    "profile.classWarrior": "Fitness Warrior ??????",
  ...
  pt: {
    ...
    "profile.classWarrior": "Guerreiro Fitness ??????",
    ...
    "profile.rarityRare": "Raro",
    "profile.rarityEpic": "�pico",
    "profile.rarityLegendary": "Lend�rio",
    "profile.achievementsListTitle": "Lista de Conquistas",
    "profile.active": "Ativos",
    "profile.adventureLog": "Di�rio de Aventuras (XP Log)",
    "profile.bronze": "Bronze ??",
    "profile.code": "C�digo:",
    "profile.createFreeAccount": "Criar Conta Gr�tis",
    "profile.emptyChest": "Ba� Vazio",
    "profile.emptyChestDesc": "Voc� n�o tem cupons. Organize eventos (+25 XP) ou participe de partidas (+15 XP) para ganhar ba�s!",
    "profile.epicItem": "Item �pico ??",
    "profile.eventsPerMonth": "Eventos/m�s",
    "profile.gold": "Ouro ??",
    "profile.guestDesc": "Explore livremente. Crie uma conta para desbloquear tudo.",
    "profile.guestDisclaimer": "Sua conta � 100% gr�tis.",
    "profile.guestTitle": "Perfil de Visitante",
    "profile.itemClaimed": "Item Resgatado! ??",
    "profile.itemClaimedDesc": "O benef�cio **{discount}** foi ativado.",
    "profile.joinCommunity": "Junte-se � comunidade",
    "profile.joinDesc": "Acesse tudo gr�tis",
    "profile.legendaryItem": "Item Lend�rio ??",
    "profile.locked": "Bloqueado",
    "profile.loginExisting": "J� tenho conta - Entrar",
    "profile.magicChest": "Ba� M�gico",
    "profile.noXp": "Sem experi�ncia ainda.",
    "profile.platinum": "Platina ??",
    "profile.players": "Jogadores",
    "profile.rating": "Avalia��o",
    "profile.silver": "Prata ??",
    "profile.unlocked": "Desbloqueado",
    "profile.xpForNextLevel": "+{xp} XP para N�vel {level}",
    "canchas.location": "Localiza��o",
    "canchas.locationSelected": "Localiza��o selecionada",
    "createEvent.intensity.principiante": "Iniciante",
    "createEvent.intensity.intermedio": "Intermedi�rio",
    "createEvent.intensity.pro": "Pr�",
  ...
  fr: {
    ...
    "profile.classWarrior": "Guerrier Fitness ??????",
    "profile.classMaster": "Ma�tre du Match ??",
    "profile.classLegend": "L�gende de Caracas ??",
    "profile.rarityNovice": "Novice",
    "profile.rarityCommon": "Commun",
    "profile.rarityRare": "Rare",
    "profile.rarityEpic": "�pique",
    "profile.rarityLegendary": "L�gendaire",
    "profile.achievementsListTitle": "Liste des Succ�s",
    "profile.active": "Actifs",
    "profile.adventureLog": "Journal d'Aventure (XP Log)",
    "profile.bronze": "Bronze ??",
    "profile.code": "Code :",
    "profile.createFreeAccount": "Cr�er un Compte Gratuit",
    "profile.emptyChest": "Coffre Vide",
    "profile.emptyChestDesc": "Vous n'avez pas de coupons. Organisez des �v�nements (+25 XP) ou rejoignez des matchs (+15 XP) pour gagner des coffres !",
    "profile.epicItem": "Objet �pique ??",
    "profile.eventsPerMonth": "�v�nements/mois",
    "profile.gold": "Or ??",
    "profile.guestDesc": "Explorez librement. Cr�ez un compte pour tout d�bloquer.",
    "profile.guestDisclaimer": "Votre compte est 100% gratuit.",
    "profile.guestTitle": "Profil Invit�",
    "profile.itemClaimed": "Objet R�clam� ! ??",
    "profile.itemClaimedDesc": "L'avantage **{discount}** a �t� activ�.",
    "profile.joinCommunity": "Rejoignez la communaut�",
    "profile.joinDesc": "Acc�dez � tout gratuitement",
    "profile.legendaryItem": "Objet L�gendaire ??",
    "profile.locked": "Verrouill�",
    "profile.loginExisting": "J'ai d�j� un compte - Connexion",
    "profile.magicChest": "Coffre Magique",
    "profile.noXp": "Pas encore d'exp�rience.",
    "profile.platinum": "Platine ??",
    "profile.players": "Joueurs",
    "profile.rating": "�valuation",
    "profile.silver": "Argent ??",
    "profile.unlocked": "D�bloqu�",
    "profile.xpForNextLevel": "+{xp} XP pour le Niveau {level}",
    "canchas.location": "Emplacement",
    "canchas.locationSelected": "Emplacement s�lectionn�",
    "createEvent.intensity.principiante": "D�butant",
    "createEvent.intensity.intermedio": "Interm�diaire",
    "createEvent.intensity.pro": "Pro",
  ...
  it: {
    ...
    "profile.classWarrior": "Guerriero Fitness ??????",
    "profile.classMaster": "Maestro del Match ??",
    ...
    "profile.guestDisclaimer": "Il tuo account � gratuito al 100%.",
    "profile.guestTitle": "Profilo Ospite",
    "profile.itemClaimed": "Oggetto Riscattato! ??",
    "profile.itemClaimedDesc": "Il vantaggio **{discount}** � stato attivato.",
    "profile.joinCommunity": "Unisciti alla comunit�",
    "profile.joinDesc": "Accedi a tutto gratis",
    "profile.legendaryItem": "Oggetto Leggendario ??",
    "profile.locked": "Bloccato",
    "profile.loginExisting": "Ho gi� un account - Accedi",
  ...
  de: {
    ...
    "profile.classRecruit": "Rekrut Anf�nger ??",
    "profile.classAspirant": "Aktiver Anw�rter ?",
    "profile.classWarrior": "Fitness Krieger ??????",
    "profile.classMaster": "Match-Meister ??",
    "profile.classLegend": "Legende von Caracas ??",
    "profile.rarityNovice": "Anf�nger",
    "profile.rarityCommon": "Gew�hnlich",
    "profile.rarityRare": "Selten",
    "profile.rarityEpic": "Episch",
    "profile.rarityLegendary": "Legend�r",
    ...
    "profile.legendaryItem": "Legend�rer Gegenstand ??",
    ...
    "profile.xpForNextLevel": "+{xp} XP f�r Level {level}",
    "canchas.location": "Ort",
    "canchas.locationSelected": "Ort ausgew�hlt",
    "createEvent.intensity.principiante": "Anf�nger",
